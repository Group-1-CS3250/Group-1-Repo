...
4. Accountability 
   ...
   Check-ins consistently in a direct and effective way
      -We will practice consistent check-ins for each group member that will catch any stress early to resolve conflicts.
   Updates from each member
      -If a member is unavailable, they must update others to ensure that plans can be changed before any conflict arises.
   Review/notes for anyone who wasn't available
      -Present team members will track meeting minutes that can be used to update any team member who is currently not present.
